...
void UInteractWidget::UpdateUI(bool bShowCursor, TScriptInterface<IInteraction> Interactable)
{
	if (bShowCursor)
	{
	...
	if (CurrentInteractable != Interactable)
	{
		if (Interactable)
		{
			InteractText->SetText(IInteraction::Execute_GetName(Interactable.GetObject()));
